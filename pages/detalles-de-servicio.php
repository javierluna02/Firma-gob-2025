...
<section class="home-section-1">
    <div class="div-1">
        <img class="" src="<?= get_template_directory_uri(); ?>/img/Group_109[1].png" alt="">
    </div>
    <div class="div-2">
...
<div style="display: flex; justify-content: center; align-items:center; flex-direction: column; ">
    ...
    <div style="display: flex; padding:20px; color: #003579;
 flex-direction: column; gap:20px; align-items: center; justify-content: center;">
        <h2>
            Portafirmas Firma Gob
        </h2>
        <p style="color: #003579;">BUSCA DE MANERA PRECISA AQUELLO QUE NECESITAS CONOCER</p>

        <div style="display: flex; flex-direction: row; align-items:center; gap: 10px;">
            <span style="color: #94AAC7;"> <img class="" src="<?= get_template_directory_uri(); ?>/img/icons8-analytics-64 (1) 19.svg" alt="">
                SEGURO</span>
            <span style="color: #94AAC7;"> <img class="" src="<?= get_template_directory_uri(); ?>/img/icons8-analytics-64 (1) 19.svg" alt="">
                OPTIMO <span style="color: #94AAC7;"> <img class="" src="<?= get_template_directory_uri(); ?>/img/icons8-analytics-64 (1) 19.svg" alt="">
                    EFICAZ</span>
        </div>
        <p style="width: 80%; color: #003579; font-weight: 500; font-size:18px;">Consiste en proveer a los organismos gubernamentales de un portafirmas altamente efectivo para administrar de manera eficiente el flujo de documentos que requieren ser firmados digitalmente. Esta solución tecnológica permite a las instituciones públicas agilizar y automatizar el proceso de firma, reduciendo la dependencia del papel y optimizando la gestión documental.</p>
    </div>
    ...
    <section style=" display:flex; justify-content: center; align-items: center; ">
        ...
        <div style=" padding:30px; width:40%;">
            ...
            <div style=" padding: 20px; width: 520px; border-radius: 20px;  box-shadow: 0px 0px 10px 0px ;
         height: 340px ; display: flex;
         flex-direction: column; justify-content: center; ">
                <div style="display: flex; align-items: center; justify-content: center; ">
                    <div style=" width:100%;  background-color: #A6D2FF63;">
                        <img class="" style=" width: 100%;" src="<?= get_template_directory_uri(); ?>/img/Group 5.svg" alt="">
                    </div>
                    ...
                    <div>
                        ...
                        <ol>
                            <li style=" color: #0066CC; " >Para tramitar este servicio, es necesario que el solicitante haya enviado la carta de solicitud firmada, sellada e inicialada por la máxima autoridad.</li>
                        </ol>
                    </div>
    ...
    <section style=" display:flex;  justify-content: center; align-items: center; ">
        ...
        <div style=" padding:30px; width:40%;">
            <div style="background-color: #0080FF; position:relative; bottom:-20px; width: 140px; height:36px; color: white; display: flex; justify-content: center; align-items: center; border-radius: 50px;  ">Documentos</div>

            <div style=" border-radius: 20px; box-shadow: 0px 0px 1px 0px;  padding: 20px; width: 520px; border:1px solid  #0080FF;
         height: 340px ; display: flex;
         flex-direction: column; justify-content: center; ">
                <div style="display: flex; flex-direction:column; align-items: center; justify-content: center; ">
                    <img class="" src="<?= get_template_directory_uri(); ?>/img/Group 83.svg" alt="">
                    <a href="miarchivo.pdf" download="MiDocumento.pdf">
                        <button style="background-color: #ED2024; border:none; border-radius: 50px; color: white; width: 156px; height: 35px ; ">Descargar PDF</button>
                    </a>
                    </button>
    ...
    ;  color: #0066CC; border: 1px solid #0066CC; border-radius:50px; background-color: white; " id="openModal" >Servicios</button>
    </div>
