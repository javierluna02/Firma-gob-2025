...
<section style="position: relative; display: flex; justify-content: center;" class="section-11">
        ...
        <article class="Cards">
            <div class="header">
                ...
                <div class="text">
                    ...
                    <p>vehicula purus sit ametvehicula purus sit amet, dictum orci. Proin sit amet turpis sed turpis
                        tempor dictum at eget orci. Mauris fermentum mollis risus, vitae dignissim sapien pharetra
                        non.pharetra non., dictum orci. Proin sit amet turpis sed turpis </p>
                </div>
            </div>
            <p>vehicula purus sit amet, dictum orci. Proin sit amet turpis sed turpis tempor dictum at eget orci. Mauris
    ...
    <div style="padding:  0; position: absolute; right:  0px;;   bottom: -121px;" class="div-3">
        ...
        <div style="padding:  0; position: absolute; left:  128px;;   bottom: 232px;" class="div-3">
        <img style="padding: 0; position: relative; top: -1px;"
            src="<?php echo esc_url(get_template_directory_uri()); ?>/img/Group 27.svg" alt="Vector decorativo">
    </div>
