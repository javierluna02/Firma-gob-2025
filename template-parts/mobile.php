            ...
            <div class="div1-section-12">
                ...
                <article style="display: flex; justify-content: center; align-items: center;">
                    <div class="div2-section-12">
                        ...
                        <div style="display: flex; flex-direction: column;">
                            ...
                            <h2 style="position: relative; bottom: -20px;">¡Únete a Firma GOB hoy!</h2>
                ...
                <article style="width: 100%; display: flex; justify-content: space-between ">
                    ...
                    <div style="display: flex;  gap: 10px; flex-direction: column;  ">
                        <button
                            style="width: 72px ; height: 72px; background-color:#0066CC ; border: none; border-radius: 50%; "><img
                                src="/img/icons8-mensaje-100 2.svg" alt=""></button>
                        <button
                            style="width: 72px ; height: 72px; background-color:#5EAEFF ; border: none; border-radius: 50%;"><img
                                src="/img/Vector 20.svg" alt=""></button>
                    </div>
